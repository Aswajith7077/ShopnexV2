...
const Navbar = () => {
  ...
  return (
    <main className="flex flex-row justify-between w-full py-5 px-10 items-center">
      ...
      <Button
        variant={'secondary'}
        className="hidden md:flex bg-slate-900 justify-start rounded-full pl-10 pr-10 py-5 w-100 border"
        onClick={() => {
          setOpen((prev) => !prev);
        }}
      >
        <Search size={36} />
        <p className="w-full justify-start mx-3 text-start text-gray-400 text-base">
          Search
        </p>
