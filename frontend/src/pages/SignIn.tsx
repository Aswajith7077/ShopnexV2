  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex flex-col items-center justify-between w-full lg:w-1/2 bg-black py-20"
      >
              ...
              <FormItem>
                <FormControl>
                  <Input
                    placeholder="Email"
                    type="email"
                    className="bg-slate-900 py-6 rounded-lg px-5"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
              ...
              <FormItem>
                <FormControl>
                  <Input
                    ...
                    type="name"
                    className="bg-slate-900 w-full py-6 rounded-lg px-5"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
