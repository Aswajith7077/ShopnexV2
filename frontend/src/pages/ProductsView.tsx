...
const ProductsView = () => {
  ...
  const { data } = useApiQuery<ProductViewResponseType>(
    API_ENDPOINTS.GET_DETAILS_ENDPOINT,
    { id: context.product_name }
  );

  if (data)
    return (
      <ScrollArea className="flex p-5 overflow-auto">
        <div className="flex flex-col">
          <div className="flex flex-row w-full gap-10 ">
            ...
            <div className="w-[60%]">
              ...
              <h1 className="font-semibold text-3xl pr-10 py-5">{data.NAME}</h1>
