    ...
    subcontents: [
      {
        ...
        icon: <IoMdPricetags size={36} className="w-1/4"/>,
        description:
      ...
      },
      {
        ...
        icon: <FaEuroSign size={36} className="w-1/4"/>,
        description:
      ...
      },
      {
        ...
        icon: <BiSolidOffer size={36} className="w-1/4"/>,
        description:
    ...
    subcontents: [
      {
        title: "FAQs",
        url: "/help/faqs",
        icon: <IoIosChatbubbles size={36} className="w-1/4"/>,
        description:
      ...
      },
      {
        title: "Support",
        url: "/help/support",
        icon: <MdGroups size={36} className="w-1/4"/>,
        description:
